...
TEST(JSONRequestBuilder, CheckAddFieldEcrNumber) {
    JSONRequestBuilder builder;
...
TEST(JSONRequestBuilder, CheckAddFieldEcrMerchantNumber) {
    JSONRequestBuilder builder;
...
TEST(JSONRequestBuilder, CheckAddFieldOperationCode) {
    JSONRequestBuilder builder;
...
TEST(JSONRequestBuilder, CheckAddFieldAmount) {
    JSONRequestBuilder builder;
...
TEST(JSONRequestBuilder, CheckAddFieldPartialAmount) {
    JSONRequestBuilder builder;
...
TEST(JSONRequestBuilder, CheckAddFieldTipsAmount) {
    JSONRequestBuilder builder;
...
TEST(JSONRequestBuilder, CheckAddFieldCashbackAmount) {
    JSONRequestBuilder builder;
...
TEST(JSONRequestBuilder, CheckAddFieldCurrencyCode) {
    JSONRequestBuilder builder;
...
TEST(JSONRequestBuilder, CheckAddFieldRRN) {
    JSONRequestBuilder builder;
...
TEST(JSONRequestBuilder, CheckAddFieldAuthCode) {
    JSONRequestBuilder builder;
...
TEST(JSONRequestBuilder, CheckAddFieldReceiptReference) {
    JSONRequestBuilder builder;
...
TEST(JSONRequestBuilder, CheckAddFieldTransactionID) {
    JSONRequestBuilder builder;
...
TEST(JSONRequestBuilder, CheckAddFieldCardDataEnc) {
    JSONRequestBuilder builder;
...
TEST(JSONRequestBuilder, CheckAddFieldOpenTags) {
    JSONRequestBuilder builder;
...
TEST(JSONRequestBuilder, CheckAddFieldEncTags) {
    JSONRequestBuilder builder;
...
TEST(JSONRequestBuilder, CheckAddFieldProviderCode) {
    JSONRequestBuilder builder;
...
TEST(JSONRequestBuilder, CheckAddFieldAdditionalInfo) {
    JSONRequestBuilder builder;
...
TEST(JSONRequestBuilder, CheckCreateObject) {
    JSONRequestBuilder builder;
    Json::Value object;
