...
TEST(TestJSONAddFieldHelper, CheckNumberField) {
    Json::Value object;
...
TEST(TestJSONAddFieldHelper, CheckStringField) {
    Json::Value object;
...
TEST(TestJSONAddFieldHelper, CheckObjectField) {
    Json::Value object;
...
TEST(TestJSONAddFieldHelper, CheckArray) {
    Json::Value array;
