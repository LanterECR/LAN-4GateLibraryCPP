...
TEST(JSONFields, CheckRequestFields) {
...
TEST(JSONFields, CheckResponseFields) {
...
TEST(JSONFields, CheckCommunicationFields) {
...
TEST(JSONFields, CheckNotificationFields) {
