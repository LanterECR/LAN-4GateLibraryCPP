...
TEST(TestStringConverter, CheckConvertToVector) {
...
TEST(TestStringConverter, CheckConvertToString) {
...
TEST(TestStringConverter, CheckConvertStringVectorString) {
...
TEST(TestStringConverter, CheckConvertVectorStringVector) {
    std::vector<uint8_t> value = {'T', 'e', 's', 't', ' ', 't', 'e', 'x', 't'};
