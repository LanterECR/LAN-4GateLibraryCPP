    ...
    namespace MessageProcessor
    {
        namespace Builder
        {
            ...
            public:
                ...
                bool addFieldTransportControlDateTime(const IResponseData& responseData, Json::Value& object);
			...
			private:
                ...
                std::map<ResponseField, std::function<bool(const IResponseData &, Json::Value &)> > m_InsertFunctions;
            };
        }
    }
}
