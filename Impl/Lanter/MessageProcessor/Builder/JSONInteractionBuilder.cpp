...
namespace Lanter
{
    namespace MessageProcessor
    {
        namespace Builder
        {
            bool JSONInteractionBuilder::createObject(const IInteractionData& interactionData, Json::Value& object)
            {
                return addCode(interactionData, object);
            }
            ...
            bool JSONInteractionBuilder::addCode(const IInteractionData& interactionData, Json::Value& object)
            {
                ...
                {
                    AddFieldsHelper::addField(object, JSONInteractionFields::getCode(), static_cast<int>(interactionData.getCode()));
                }
